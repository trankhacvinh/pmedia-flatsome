...
final class PMFAI_Admin_Pages
{
    ...
    {
        echo '<div class="wrap pmfai-wrap">'; self::header('Page Builder AI', 'Sinh từng phần hoặc cả trang, ghép thành shortcode Flatsome section + HTML block.');
        echo '<div class="pmfai-panel"><div class="pmfai-grid-2"><label class="pmfai-field"><span>Build mode</span><select id="pmfai-page-build-mode"><option value="full-page">Sinh cả trang</option><option value="single-section">Sinh từng section</option></select></label><label class="pmfai-field"><span>Cost / Quality Mode</span><select id="pmfai-page-cost-mode"><option value="fast">Fast / Cheap</option><option value="balanced" selected>Balanced</option><option value="high">High Quality</option></select></label></div><label class="pmfai-field"><span>Brief trang</span><textarea id="pmfai-page-brief" rows="8" placeholder="Ví dụ: Tạo trang chủ cho công ty thiết kế website, gồm hero, dịch vụ, quy trình, dự án, FAQ, CTA..."></textarea></label><p><button class="button button-primary" id="pmfai-page-generate">Generate Page</button> <button class="button" id="pmfai-page-bridge">Tạo prompt ChatGPT</button></p><textarea id="pmfai-page-prompt" rows="10" readonly></textarea></div>';
